...
export const metadata = {
  title: "Pelayanan Publik - SK Jam Pelayanan - Kecamatan Banjarmangu",
};

const PDF_URL = "https://banjarmangu.banjarnegarakab.go.id/wp-content/uploads/2026/08/SK-jam-pelayanan.pdf";
const SOURCE_URL = "https://banjarmangu.banjarnegarakab.go.id/sk-jam-pelayanan/";

export default function SkJamPelayananPage() {
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
      ...
      <section>
        ...
        <p className="text-sm text-[var(--color-muted-foreground)] mb-4">
          Surat Keputusan tentang Jam Pelayanan Kecamatan Banjarmangu.
        </p>
        ...
        <div className="rounded-2xl border border-[var(--color-border)] bg-white overflow-hidden">
          <div className="flex items-center justify-between border-b border-[var(--color-border)] px-4 py-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-[var(--color-foreground)]">SK Jam Pelayanan</span>
            </div>
            <a
              href={PDF_URL}
              target="_blank"
