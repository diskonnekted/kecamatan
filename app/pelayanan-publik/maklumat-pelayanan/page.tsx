...
export const metadata = {
  title: "Pelayanan Publik - Maklumat Pelayanan - Kecamatan Banjarmangu",
};

const PDF_URL = "https://banjarmangu.banjarnegarakab.go.id/wp-content/uploads/2025/11/maklumat-pelayanan.pdf";
const SOURCE_URL = "https://banjarmangu.banjarnegarakab.go.id/layanan/maklumat-pelayanan/";
...
export default function MaklumatPelayananPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
      ...
      <PelayananTabNav active="maklumat" />
      ...
      <section>
        ...
        <p className="text-sm text-[var(--color-muted-foreground)] mb-4">
          Maklumat pelayanan publik Kecamatan Banjarmangu sebagai komitmen penyelenggaraan pelayanan yang prima.
        </p>
